...
select to_char(sysdate, 'ddmmyy_hh24miss') ddate
  from dual;  
define edition_name = "ed_patch_&patch_num._&tmpdate";
...
comment on edition &edition_name is 'Install patch &patch_num';
...
prompt wallet_api_pack.spc
@@objects/wallet_api_pack.spc

prompt wallet_api_pack.bdy
@@objects/wallet_api_pack.bdy
...
-------------------------------------------
prompt 
prompt Install updates for wallet_api_pack have been successfull :)
prompt 
